                    ...
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="@if(Auth::user()->hasRole('Administrator')) {{ route('admin.dashboard') }} @elseif(Auth::user()->hasRole('Driver')) {{ route('driver.dashboard') }} @endif">Back to Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
