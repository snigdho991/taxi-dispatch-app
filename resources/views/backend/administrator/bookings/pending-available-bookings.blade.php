...
@section('title', 'Available Pending Bookings')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Available Pending Bookings (<?php echo $available_bookings->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Available Pending Bookings</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Available Pending Bookings (<?php echo $available_bookings->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="{{ route('delete.all.available') }}" method="post" novalidate="" style="margin-bottom: 10px; ">
                                @csrf
                                    <p style="text-align: center;">
                                        <button type="submit" onclick="return confirm('Are you sure to delete all the available bookings permanently?')" class="btn btn-danger waves-effect waves-light btn-sm">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Uber List</th>
                                        <th>Flight Number</th>
                                ...
                                <tbody>
                                    @foreach($available_bookings as $key => $data)
                                        <tr>
                                                    ...
                                                    @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <button type="submit" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="mdi mdi-close-thick"></i></button>
                                                            </div>
                                                        </div>
                                            ...
                                            <td>
                                                <form action="{{ route('mark.uber') }}" method="post">
                                                    @csrf

                                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                                    <button class="btn btn-light btn-sm waves-effect waves-light"> Add <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i> </button>
                                                </form>
                                            </td>
