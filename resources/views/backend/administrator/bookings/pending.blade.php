...
@section('title', 'All Pending Bookings')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">All Pending Bookings (<?php echo $pending->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">All Pending Bookings</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-primary"><b>All Pending Bookings (<?php echo $pending->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="{{ route('delete.all.pending') }}" method="post" novalidate="" style="margin-bottom: 10px; ">
                                @csrf
                                    <p style="text-align: center;">
                                        <button type="submit" onclick="return confirm('Are you sure to delete all the pending(available & not available both) bookings permanently?')" class="btn btn-danger waves-effect waves-light btn-sm">
                            ...
                            <p class="card-title-desc">Bookings will be automatically added to the <b class="text-success">Available Bookings</b> whenever you will add a price of a booking. That means drivers will be able to see that particular booking and <b>accept</b>. Otherwise bookings will be <b class="text-danger">Not Available Bookings</b>.
                            </p>
