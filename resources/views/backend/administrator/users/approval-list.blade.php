...
@section('title', 'Drivers Approval')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Drivers Approval (<?php echo $need_approval->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Drivers Approval</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Drivers Approval (<?php echo $need_approval->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <span style="display: inline-flex; flex-direction: row; gap: 15px;">
                                                    ...
                                                    <form action="{{ route('approve.driver') }}" method="POST">
                                                        @csrf

                                                        <input type="hidden" name="id" value="{{ $data->id }}">
                                                        <button class="btn btn-success btn-sm waves-effect btn-label waves-light"> 
                                                            <i class="bx bx-check-double label-icon"></i> Approve
                                                        </button>
                                                    </form>

                                                    <form action="{{ route('decline.driver') }}" method="POST">
                                                        @csrf
