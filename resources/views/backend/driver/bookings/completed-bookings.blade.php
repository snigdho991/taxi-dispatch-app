...
@section('title', 'My Completed Bookings')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Completed Bookings (<?php echo $completed_bookings->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Completed Bookings</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>My Completed Bookings (<?php echo $completed_bookings->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                @foreach($completed_bookings as $key => $booking)
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center" style="margin-bottom: 0px; margin-top: 20px;"><a class="btn btn-dark btn-sm" href="{{ route('view.map', $booking->id) }}"><i class="bx bx-map-pin me-1" style="position: relative; top: 1px;"></i> View Map <i class="bx bxs-right-arrow" style="position: relative; top: 1.3px;"></i></a></p>
                                
                            </div>

                            <div class="card-footer bg-transparent border-top text-center">
                                <span class="text-dark font-size-13 text-center"> <i class="bx bx-calendar-check font-size-15" style="position: relative; top: 1.49px;"></i> Completed {{ $booking->created_at->diffForHumans() }} </span>
                            </div>
