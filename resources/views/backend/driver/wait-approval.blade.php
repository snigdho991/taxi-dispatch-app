...
<html lang="en">
    ...
    <body>
        <span>
            ...
            <form method="POST" action="http://taxi-dispatch-app.test/logout" style="float: right; margin-top: -40px;">
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <h4 style="margin-top:15px;">Your account is waiting for our administrator approval.
                                <br />
